...
var btnTheme = document.querySelector('.fa-lightbulb');
...
var toggleTheme = function toggleTheme() {
  return isDark() ? setTheme('body-light', 'fa-lightbulb') : setTheme('body-dark', 'fa-sun');
};
...
var src_btnTheme = document.querySelector('.fa-lightbulb');
